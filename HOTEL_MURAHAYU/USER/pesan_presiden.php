...
<head>
    ...
    if (checkInValue && checkOutValue) {
        ...
        var hargaPerHari = 2000000; // Ganti dengan harga per hari yang sesuai
        ...
        function confirmPesan() {
            ...
            if (checkIn && checkOut) {
                var harga = (new Date(checkOut) - new Date(checkIn)) / (1000 * 60 * 60 * 24) * 2000000;
...
<body>
    ...
    <h3>Masukan Data Pemesanan</h3>
        <form method="post" action="aksi_presiden.php"  onsubmit="return confirmPesan()">
            <table>
                <tr>
                    <td>No KTP</td>
