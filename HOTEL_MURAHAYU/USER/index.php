...
<body>
    <nav>
        <div class="nav__bar">
            ...
            <ul class="nav__links" id="nav-links">
                ...
                <li><a href="../TRANSAKSI/histori_booking.php">Histori Pesanan</a></li>
                <li><a href="#" onclick="logout()">Logout</a></li>
                
                <script>
                  function logout() {
                   let text = "Anda Yakin Ingin Keluar ?";
                     if (confirm(text)) {
                       window.location.href = '../LOGIN_USER/logout.php';
                     } else {
                 }
        }
                </script>
    ...
    <section class="room__container" id="room">
          ...
          <div class="room__card" id="ds">
            ...
            <div class="room__card__details">
              <div>
                ...
                <br>
                <a href="pesan_kamar.php" class="pesan">Pesan</a>
              </div>
          ...
          <div class="room__card" id="fs">
            ...
            <div class="room__card__details">
              <div>
                ...
                <br>
                <a href="pesan_vip.php" class="pesan">Pesan</a>
          ...
          <div class="room__card" id="lp">
            ...
            <div class="room__card__details">
              <div>
                ...
                <br>
                <a href="pesan_presiden.php" class="pesan">Pesan</a>
      ...
      const targetElement = e.target.closest('#ds,#fs,#lp');
      if (targetElement) {
        const targetUrl = targetElement.getAttribute('data-target-url');
        if (targetUrl) {
