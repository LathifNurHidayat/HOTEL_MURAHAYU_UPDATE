...
<head>
    ...
    if (checkInValue && checkOutValue) {
        ...
        var hargaPerHari = 900000; // Ganti dengan harga per hari yang sesuai
        ...
        function confirmPesan() {
            ...
            if (checkIn && checkOut) {
                var harga = (new Date(checkOut) - new Date(checkIn)) / (1000 * 60 * 60 * 24) * 900000;
...
<body>
    ...
    <header class="header" id="home">
        <center>
            <div class="utama">
                <h3>Masukkan Data Pemesanan</h3>
                <form method="post" action="aksi_biasa.php" onsubmit="return confirmPesan()">
                    <table>
                        <tr>
                            <td>No KTP</td>
                        ...
                        <tr>
                            ...
                            session_start();
                            include "koneksi.php";
                             echo isset($_SESSION['email']) ? $_SESSION['email'] : ''; ?>" readonly>
                             </td>
                        </tr>
